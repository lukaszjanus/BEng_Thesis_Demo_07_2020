...
<script type="text/javascript">
	...
	/* informational communicates from cookies */
	...
	<div class="container">
		...
		<div class="content">
			<div class="logonBackgroundImage">
				...
				<div id="leftForms">
					<form:form
						action="${pageContext.request.contextPath}/adminTools/saveUpdatedUser"
				...
				<div id="rightForms">
					<table>
						<tr>
							<td>
								<table>
									...
									<form:form
										action="${pageContext.request.contextPath}/adminTools/changePassword"
						...
						<tr>
							<td>
								<form
									action="${pageContext.request.contextPath}/adminTools/removeRoleToUser"
						...
						<tr>
							<td>
								<form
									action="${pageContext.request.contextPath}/adminTools/addRoleToUser"
				...
				<div class="backToUserList">
					<form:form
						action="${pageContext.request.contextPath}/adminTools/ActiveUsers"
						method="GET">
