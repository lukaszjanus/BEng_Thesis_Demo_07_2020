...
/**
 * Controller-Class with methods to customize file uploading for 'Manager'.
 * 
 * Annotations:
 ...
 * RequestMapping - mapping of manager area, all methods have added prefix from this annotation
 * ResponseBody - method used by ajax.
 * 
 * @author Lukasz Janus
 * @version 1.0
 * @date 13 lut 2020
...
public class ManagerUploadCustomize {
	...
	public String reportsCustomizeGet(Model model, HttpServletRequest res) {
		...
		return "functions/UploadCustomizeM";
	}
	...
	public String reportsCustomizePost(HttpServletResponse res, Model model,
		...
		case 1: {
			...
			cookie.setMaxAge(5);
			res.addCookie(cookie);
			return "redirect:/manage/UploadCustomize";
		}
		}
		return "redirect:/manage/UploadCustomize";
	}
