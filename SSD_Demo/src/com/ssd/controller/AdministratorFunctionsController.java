...
/**
 * Class with controllers and models for management functions dedicated to role 'Administrator'.
 * 
 * Annotations:
...
public class AdministratorFunctionsController {
	 ...
	 * 
	 * @PostMapping -  read post-action 'adminTools/FunctionList'
	 * 
	 ...
	 */
	@PostMapping("adminTools/FunctionList")
	public String saveNewFunctionA(@ModelAttribute Functions function, Model model, HttpServletResponse res)
		...
		case 0: {
			...
			//return "/functions/addFunctionA";
			return "redirect:/adminTools/FunctionList";
		}
		case 1: {
	 ...
	 * 
	 * @PostMapping -  read post-action 'adminTools/editFunctionDescription'
	 * 
	 ...
	 * @throws IOException
	 */
	@PostMapping("adminTools/editFunctionDescription")
	 ...
	 * 
	 * @PostMapping -  read post-action 'adminTools/disableFunction'
	 * 
	 ...
	 * @throws IOException
	 */
	@PostMapping("adminTools/disableFunction")
	 ...
	 * 
	 * @PostMapping -  read post-action 'adminTools/enableFunction'
	 * 
	 ...
	 * @throws IOException
	 */
	@PostMapping("adminTools/enableFunction")
